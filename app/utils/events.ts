...
export const disableMouseEvents = () => {
  document.addEventListener("mousemove", disableMouseEvent, { passive: false });
  document.addEventListener("mousedown", disableMouseEvent, { passive: false });
  ...
  document.addEventListener("dblclick", disableMouseEvent, { passive: false });
  ...
  document.addEventListener("touchmove", disableMouseEvent, { passive: false });
